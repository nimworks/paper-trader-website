...
self.__precacheManifest = [
  ...
  {
    "url": "img/kaagzi.webp",
    "revision": "6d1a07b2ecad1169fee911e6414f174e"
  },
  {
    "url": "framework-8649e59c0818567074fb.js"
  },
  {
    "url": "app-c69a7793a7d35afcd84b.js"
  },
  {
    "url": "offline-plugin-app-shell-fallback/index.html",
    "revision": "9fe501f0067d70c77cb6d28eef31cd9e"
  },
  {
    "url": "styles.21b2c5dab3a3e19b92eb.css"
  },
  {
    "url": "webpack-runtime-00abd4b42d7bf9eaaef8.js"
  },
  {
...
const navigationRoute = new NavigationRoute(async ({ event }) => {
  ...
  if (!resources || !(await caches.match(`/app-c69a7793a7d35afcd84b.js`))) {
    return await fetch(event.request)
  }
	...
	if (event.request.mode === 'navigate') {
		event.respondWith(
			fetch(event.request).catch(async () => {
				...
				// if (url.pathname.startsWith('/app/upstox')) {
				if (event.request.url.endsWith('/app/upstox')) {
					return caches.match('/app/upstox');
				}
				// if (url.pathname.startsWith('/app/angelOne')) {
				if (event.request.url.endsWith('/app/angelOne')) {
